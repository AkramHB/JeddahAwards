            ...
            while($row = $result->fetch_assoc()) {
                ...
                "<div class = 'container mt-5'>
                    ...
                    <div class = 'row' style = 'color: #A19B41;'>
                        ...
                        <div class = 'col-6 text-left'>
                            <h3>
                                ...
                                <a href = 'delete+ind.php?data=$un'><i class='material-icons'>remove_circle</i></a>
                            </h3>
                        </div>
                    </div>
                    ...
                    <div class = 'row justify-content-center mt-5 border-top'>
                        ...
                        <div class = 'col-9 text-right border-bottom'>
                            <h5><a class = 'btn btn-default' href = '../uploads/" . $row['ack'] . "'>تحميل </a></h5>
                        </div>
                        ...
                        <div class = 'col-9 text-right border-bottom'>
                            <h5><a class = 'btn btn-default' href = '../uploads/" . $row['cer'] . "'>تحميل </a></h5>
                        </div>
                        ...
                        <div class = 'col-9 text-right border-bottom'>
                            <h5><a class = 'btn btn-default' href = '../uploads/" . $row['cer2'] . "'>تحميل </a></h5>
                        </div>
                        ...
                        <div class = 'col-9 text-right border-bottom'>
                            <h5><a class = 'btn btn-default' href = '../uploads/" . $row['cer3'] . "'>تحميل </a></h5>
                        </div>
                        ...
                        <div class = 'col-9 text-right border-bottom'>
                            <h5><a class = 'btn btn-default' href = '../uploads/" . $row['cer4'] . "'>تحميل </a></h5>
                        </div>
                        ...
                        <div class = 'col-9 text-right border-bottom'>
                                <h5><a class = 'btn btn-default' href = '../uploads/" . $row['cer5'] . "'>تحميل </a></h5>
                        </div>
                        ...
                        <div class = 'col-9 text-right border-bottom'>
                            <h5><a class = 'btn btn-default' href = '../uploads/" . $row['cer6'] . "'>تحميل </a></h5>
                        </div>
                        ...
                        <div class = 'col-9 text-right border-bottom'>
                            <h5><a class = 'btn btn-default' href = '../uploads/" . $row['cer7'] . "'>تحميل </a></h5>
                        </div>
                        ...
                        <div class = 'col-9 text-right border-bottom'>
                            <h5><a class = 'btn btn-default' href = '../uploads/" . $row['cer8'] . "'>تحميل </a></h5>
                        </div>
                        ...
                        <div class = 'col-9 text-right border-bottom'>
                            <h5><a class = 'btn btn-default' href = '../uploads/" . $row['cer9'] . "'>تحميل </a></h5>
                        </div>
